...
description: >-
  ...
  overviews, alternatives, and decision rationale documents to learning/. Use
...
- Producing design documents under `learning/`.
...
- `learning-log` — write design documents to `learning/`.
...
5. Log everything via `learning-log` into files like:
   ...
   - `learning/decision-<design-change>.md`
